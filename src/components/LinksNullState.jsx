...
I built this feature over a few nights and weekends because I wasn't satisfied with the available solutions for bookmarking. I tried using [Instapaper](https://instapaper.com), [Pocket](https://getpocket.com), Medium's [Journal](https://usejournal.com), and a few others, but there was something missing about each of them.
...
- **Tag** links and notes to keep certain things organized. For example, I have resturants tag for all of the websites of new resturants I'd like to go to.
...
Mobile apps for iOS and Android are also on the road map, so you'll be able to links from your phone too. Please [let me know](/convos/new?userId=Eg8KBFVzZXIQgICAuI6DhQo) if you have any feedback and thanks for giving Convo a try. 🙂
